        ...
        if (count($dataResult) > 0) {
            foreach ($dataResult as $rs) { ?>
                <tr>
                    ...
                    <td>
                        <?= date('d-m-Y', strtotime($rs->pembelianobat_tanggal)); ?>
                    </td>
                    <td>
                         <?= $rs->pembelianobat_no_faktur; ?>
                    </td>
                    <td>
                    ...
                    ?>
                    <td>
                        Rp. <?= number_format(ceil($jumlah[0]->jumlah), 0, ",", ".");
                                    $no++; ?>
                    </td>
                    <td>
                         <?= $rs->created_oleh; ?>
                    ...
                    <td>
                        <a type="button" class="btn btn-primary" data-toggle="tooltip" data-original-title="Play" id="all" onclick='changeIcon(<?= $rs->pembelianobat_id; ?>)' ><i class="fa fa-play" id="icon_<?= $rs->pembelianobat_id; ?>"  ></i></a>
