                    ...
                    <div class="form-group">
                            <select class="form-control select2" id="" name="">
                                ...
                                <?php foreach ($program as $key => $val) : ?>
                                    <option value="<?php echo $val->fitproglat_id; ?>"><?php echo $val->fitproglat_name ?></option>
                                <?php endforeach ?>
                            </select>
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <label>Intensitas</label>
                            <select class="form-control select2" id="" name="">
                                ...
                                <?php foreach ($intensitas as $key => $val) : ?>
                                    <option value="<?php echo $val->fitinten_id; ?>"><?php echo $val->fitinten_name ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
