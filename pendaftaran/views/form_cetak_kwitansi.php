	...
	<div class='to-print' style="font-family: Calibri; font-weight:bold;">
		...
		<table class="text-left" cellpadding="10" style="margin-bottom: -15px;">
			<tr>
				...
				<!-- <td style="font-size:11pt;"><?php echo $datakwitansi->yogabill_inv_number; ?></td> -->
			</tr>
			<tr>
				<td style="font-size:11pt;">Tgl. Kwitansi</td>
				<td style="font-size:11pt;">:</td>
				<!-- <td style="font-size:11pt;"><?php echo $datakwitansi->created_on; ?></td> -->
				
			</tr>
			<tr>
				<td style="font-size:11pt;">Nama Member</td>
				<td style="font-size:11pt;">:</td>
				<!-- <td style="font-size:11pt;"><?php echo $datakwitansi->yogabill_peserta; ?></td> -->
		...
		<table class="text-left" width="100%" cellpadding="10" style="margin-bottom: -15px;">
			...
			<tr>
				<td style="text-align: left; margin-top: 5px;font-size:11pt;"></td>
			</tr>
		</table>
